export const environment = {
  production: false,
  firebaseConfig: {
    // apiKey: "AIzaSyADVjTeEvncM1LSAThpNP1dbeitVK3P6bw",
    // authDomain: "gdh-masajes-prod.firebaseapp.com",
    // databaseURL: "https://gdh-masajes-prod.firebaseio.com",
    // projectId: "gdh-masajes-prod",
    // storageBucket: "gdh-masajes-prod.appspot.com",
    // messagingSenderId: "957892310927"
